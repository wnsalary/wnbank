...
System.out.println("have_done_json.jsp中 uuid==="+uuid);
...
System.out.println("have_done_json.jsp中  site==="+site);
%><%
if(userid!=null&&!userid.equals("")){
    String sql = "select b.templetname,a.count,a.templetcode from (select templetcode,count(*) count from pub_task_off where realdealuser='"+userid+"' or accruserid='"+userid+"'  group by templetcode) a left join CNTP4_PUB_TEMPLET b on a.templetcode=b.templetcode";
