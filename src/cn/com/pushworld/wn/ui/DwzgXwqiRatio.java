...
//		
//=======
					String str=service.getDwzgXwqyRatio(listPanel.getQuickQueryPanel().getCompentRealValue("DATE_TIME").substring(0,listPanel.getQuickQueryPanel().getCompentRealValue("DATE_TIME").length()-1));
					MessageBox.show(this,str);
					listPanel.QueryData(listPanel.getQuickQueryPanel().getQuerySQL());
				}else{
					listPanel.QueryData(listPanel.getQuickQueryPanel().getQuerySQL());
				}
