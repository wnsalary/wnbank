 ...
 *
 */
public class GYServerSearchWKPanel extends AbstractWorkPanel implements  ActionListener,BillListHtmlHrefListener {
	...
	public void onBillListHtmlHrefClicked(BillListHtmlHrefEvent e) {
		if(e.getSource()==listPanel){
			...
			BillListDialog dialog=new BillListDialog(this, "查看", "V_GYSERVER2_ZPY_Q01");
			dialog.getBilllistPanel().QueryDataByCondition("usercode='"+usercode+"' and pftime='"+pftime+"'");
