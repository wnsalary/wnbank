...
public class GYWorkSearchWKPanel extends AbstractWorkPanel implements ActionListener,BillListHtmlHrefListener {
	...
	public void onBillListHtmlHrefClicked(BillListHtmlHrefEvent e) {
		if(e.getSource()==listPanel){
			...
			BillListDialog dialog=new BillListDialog(this, "²é¿´", "V_GYWORK2_ZPY_Q01");
