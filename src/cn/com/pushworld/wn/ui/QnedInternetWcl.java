...
public class QnedInternetWcl extends AbstractWorkPanel implements ActionListener{

	/**
	 * @author FJ[黔农E贷线上替代完成率]
	 * 2019年6月4日14:31:49
	 */
	...
	private void Querydate() {
		...
		try {
			...
			if(data.length<=0){
				...
				String result = service.getQnedXstd(billListPanel.getQuickQueryPanel().getCompentRealValue("time").substring(0,billListPanel.getQuickQueryPanel().getCompentRealValue("time").length()-1));
