...
public class QnedtdParticularsWKPanel extends AbstractWorkPanel implements BillListHtmlHrefListener, ActionListener {
...
//				String condition = listPanel.getQuickQueryPanel().getQuerySQLCondition();//获取到当前查询条件
...
//                    String sql="select * from wn_qnedtd where 1=1 and mName='"+username+"' and date_time='"+date_time+"'";
...
//				}
	...
	public void onBillListHtmlHrefClicked(BillListHtmlHrefEvent e) {
         if(e.getSource()==listPanel){
        	 ...
        	 dialog.getBilllistPanel().QueryDataByCondition("username='"+vo.getStringValue("mname")+"' and date_time='"+date_time.substring(0,7)+"'");
