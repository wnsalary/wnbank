 ...
 */
public class QnedtdSearchWKPanel extends AbstractWorkPanel implements ActionListener,BillListHtmlHrefListener {
	...
	public void onBillListHtmlHrefClicked(BillListHtmlHrefEvent e) {
		if(e.getSource()==listPanel){
			...
			dialog.getBilllistPanel().QueryDataByCondition("xd_col1='"+vo.getStringValue("DKNO")+"'");
