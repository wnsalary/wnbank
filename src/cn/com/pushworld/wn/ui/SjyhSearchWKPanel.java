...
public class SjyhSearchWKPanel extends AbstractWorkPanel implements ActionListener {
	...
	private void QuerySearch() {
		try {
			...
			String cus_name=listPanel.getQuickQueryPanel().getCompentRealValue("XD_COL5");
			if(cus_name!=null&&!cus_name.isEmpty()){
				sql=sql+" and XD_COL5 like '%"+cus_name+"%'";
			}
			String  manager_no=listPanel.getQuickQueryPanel().getCompentRealValue("XD_COL2");
