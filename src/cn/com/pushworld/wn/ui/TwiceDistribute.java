...
public class TwiceDistribute extends AbstractWorkPanel implements ActionListener{
	...
	public void onSelect() {
		...
		if(billvo==null||billvo.equals("")){
			...
			BillCardDialog cardDialog = new BillCardDialog(billListPanel, "查看", cardPanel, WLTConstants.BILLDATAEDITSTATE_INIT);
	...
	public void onEdit() {
		...
		if(status.equals("已提交")){
			...
			BillCardPanel cardpanel = new BillCardPanel("WN_TWICEDISTRIBUTE_CODE1");
			cardpanel.setBillVO(billvo);
			BillCardDialog dialog = new BillCardDialog(billListPanel, "编辑", cardpanel, WLTConstants.BILLDATAEDITSTATE_UPDATE);
	...
	public void onSubmit() throws Exception {
		...
		if(billvo==null){
			...
			uiutil.executeUpdateByDS(null,"update wn_twicedistribute set status='已提交' where id='"+id+"'");
