...
public class TyxwParticularsWKPanel   extends AbstractWorkPanel implements BillListHtmlHrefListener,ActionListener{
...
//		wdList=Arrays.asList(new String[]{"西海信用社","人民南路分社","人民中路分社","营业部","草海信用社","龙凤分社","鸭子塘信用社","新区信用社"}) ;
		this.add(list);
	}
