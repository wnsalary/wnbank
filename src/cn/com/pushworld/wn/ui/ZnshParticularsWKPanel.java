...
public class ZnshParticularsWKPanel  extends AbstractWorkPanel implements BillListHtmlHrefListener,ActionListener{
...
//		listPanel.addBillListHtmlHrefListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		if(list.getQuickQueryPanel()==e.getSource()){
			try {
//				String username=ClientEnvironment.getInstance().getLoginUserName();//获取到客户经理
//			    String condition=listPanel.getQuickQueryPanel().getQuerySQLCondition();
...
//					String sql="select * from V_WN_ZNWH where B='"+username+"' and date_time='"+condition+"'";
